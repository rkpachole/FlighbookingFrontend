      ...
      <div className="main-content app-content">
            <div className="container-fluid">
                <div className="page-header">
                    <h1 className="page-title fw-bold my-auto">Admin Balance Sheet</h1>
                    <div>
                        <ol className="breadcrumb mb-0">
                        <li className="breadcrumb-item">
                        <Link to={`/ad/dashboard`}>Dashboard</Link>
                        </li>
                        <li className="breadcrumb-item active" aria-current="page">Admin Balance Sheet</li>
                        </ol>
                    </div>
                </div>
                <div className='row'>
                            ...
                            <div class="card-body">
                                <div className="col-sm-12 col-lg-12">
                                    <div id="responsiveDataTable_filter" className="dataTables_filter row d-flex">
                                        <div className='col-4 text-start'>
                                            <h5 className='fw-bold mt-3'>Admin Balance Sheet List</h5>
                                        </div>
                                ...
                                <div className="table-responsive">
                                    <table className="table text-nowrap w-100">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Wednesday 10 Jan 2024 08:14 PM</td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className='' style={style}> 
                                                        <span className=''>Flight: <b>Indigo 823</b> </span>
                                                        <spna>Destination: <b> Ahmedabad-AMD <i class="fa-solid fa-chevron-right"></i>  Kochi-COK</b></spna>
                                                        <spna>Fare Type: </spna>
                                                        <spna>Class: <b>Economy</b></spna>
                                                    </div>
                                                </td>
                                                <td><span className='bg-info text-white text-center p-1 rounded' >Wallet</span></td>
                                                <td>20 INR </td>
                                                <td>3 INR</td>
                                                <td>1284 INR</td>
                                            </tr>
