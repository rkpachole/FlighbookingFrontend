...
export default function FlightInvoice() {
  return (
    <>
      <Layout />
      <div className="main-content app-content">
            <div className="container-fluid">
                <div className="page-header">
                    <h1 className="page-title fw-bold my-auto">Flight Invoice</h1>
                    <div>
                        <ol className="breadcrumb mb-0">
                        <li className="breadcrumb-item">
                        <Link to={`/ad/dashboard`}>Dashboard</Link>
                        </li>
                        <li className="breadcrumb-item active" aria-current="page">Flight Invoice</li>
                        </ol>
                    </div>
                </div>
                <div className='row'>
                                ...
                                <div className="col-sm-12 col-lg-12">
                                    <div id="responsiveDataTable_filter" className="dataTables_filter row d-flex">
                                        <div className='col-4 text-start'>
                                            <h5 className='fw-bold mt-3'>Flight Invoice</h5>
                                        </div>
                                    ...
                                    <table className="table text-nowrap w-100">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>--</td>
                                                <td>
                                                    <button className='btn btn-danger'><i class="fa-solid fa-print"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
