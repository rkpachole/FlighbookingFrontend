...
export default function FlightDetailModel({ show, handleClose, currency, viewListOfFlight ,layover,fareDetail,already}) {
  ...
  const handleClickGetSearchRule = () => {
    const requestParam = {
      id: fareDetail ? fareDetail.fareRuleId :"",
      flowType: fareDetails ? fareDetails?.flowType :"",
    };
          ...
          <div className="tab-content" id="nav-tabContent">
              ...
              aria-labelledby="nav-flight-details-tab" >
                ...
                <div className="">
                  <div className="card-header">
                    <div className='row'>
                      <div className='col-6'>
                        <p className='flightname mb-0'>{viewListOfFlight[0]?.departureAirportInformation?.city} <i class="fa-solid fa-arrow-right-long"></i>  {viewListOfFlight[viewListOfFlight.length-1]?.arrivalAirportInformation?.city}  <span className='flightnumber'>On {Moment(viewListOfFlight[0]?.departureDate).format('ddd, MMM DD YYYY')}</span></p>
                      </div>
                      {
                  ...
                  <div className='card-body'>
                    <div className='row'>
                      <div className='col-12'>
                        {viewListOfFlight &&
                          viewListOfFlight.map((flightValue, flightKey) =>
                          ...
                          (
                            ...
                            <div className='row'>
                              ...
                              {viewListOfFlight.length > 1 && (flightKey < viewListOfFlight.length - 1) &&
                ...
                <table className="table text-nowrap table-bordered">
                  ...
                  <tbody>
                    <tr>
                        ...
                        <div className="d-flex">
                          <img
                            className="flight-flag"
                             src={viewListOfFlight? viewListOfFlight[0].flightLogo:viewListOfFlight ? viewListOfFlight[0]?.flightLogo:"0" }
                            alt=""
                          />
                          <div className="">
                      ...
                      <th>{fareDetail.baggageInformation.checkInBaggage ? fareDetail.baggageInformation.checkInBaggage:"0 kg"}</th>
                      <th>{fareDetail.baggageInformation.cabinBaggage ? fareDetail?.baggageInformation?.cabinBaggage:"0 kg"}</th>
                    </tr>
                    <tr>
            ...
            >
              {searchRule && searchRule.DATECHANGE ? (
                  ...
                  <table className="table text-nowrap table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <th>Reissue</th>
                        <th>{viewListOfFlight[0]?.fromCityOrAirport?.city ? viewListOfFlight[0]?.fromCityOrAirport?.city : viewListOfFlight[0]?.departureAirportInformation?.city}</th>
                        <th>{viewListOfFlight[0]?.toCityOrAirport?.city ? viewListOfFlight[0]?.toCityOrAirport?.city : viewListOfFlight[viewListOfFlight.length - 1]?.arrivalAirportInformation?.city}</th>
                        <th></th>
                        <th>INR 0*</th>
                      </tr>
                    </tbody>
                ...
                <div className="record-not-found-rule">Records not found</div>
              )}
            </div>
