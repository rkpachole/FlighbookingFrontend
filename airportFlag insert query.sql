SELECT * FROM bookingc.countriesflag;
INSERT INTO
    bookingc.countriesflag(country,code,fullCode,url)
VALUES
...
('United State', 'US', 'USA', 'https://www.worldometers.info//img/flags/small/tn_us-flag.gif'),
('South America', 'VE', 'VE', 'https://www.worldometers.info//img/flags/small/tn_ve-flag.gif')